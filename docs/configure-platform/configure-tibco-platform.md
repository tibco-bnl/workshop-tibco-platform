...
Open the following URL: <https://mail.tacp.azure.nl.eu.abnamro.com/>
...
Open the following URL in a webbrowser in Windows: <https://subscription.tacp.azure.nl.eu.abnamro.com/>
...
2. Enter the prefix of the hostname of the control plane. Use: '`subscription`'.
...
**a)** Open an **NEW** browser (use a different browser, not the browser used for step 3, or open a private browser tab on the browser used in step 3) and open <https://subscription.tacp.azure.nl.eu.abnamro.com/>, click on the button '**Sign in with Default IdP**'.

**Please mind**: we will use two browser from here on:

1. A browser for the platform (<https://subscription.tacp.azure.nl.eu.abnamro.com/>)
2. A browser for the subscription (<https://subscription.tacp.azure.nl.eu.abnamro.com/>)
...
**e)** Go back the subscription browser in which you opened <https://subscription.tacp.azure.nl.eu.abnamro.com/>.
...
**a)** Open <https://subscription.tacp.azure.nl.eu.abnamro.com/> in the browser window. Click on the button '**Sign in with Default IdP**'.
...
Go back to your browser (with the subscription = <https://subscription.tacp.azure.nl.eu.abnamro.com/>)
